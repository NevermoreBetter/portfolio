      ...
      <article className="portfolio__item">
       <div className="portfolio__item-image">
        <a href="https://space-next-ten.vercel.app/" target="_blank">
         {" "}
         <img src="/Assets/jobsearch.png" alt="" />
        </a>
       </div>
       <div className="portfolio__item-info">
        ...
        <div className="portfolio-links">
         <a
          className="git"
          href="https://github.com/NevermoreBetter/Jobsearch"
          target="_blank"
         >
          GitHub
         </a>
         <a className="demo" href="https://jobsearch-umber.vercel.app/">
          Live Demo
         </a>
        </div>
       </div>
      ...
      <article className="portfolio__item">
       ...
       <div className="portfolio__item-info">
        ...
        <div className="portfolio-links">
         ...
         <a className="demo" href="https://ip-tracker-sooty.vercel.app/">
          Live Demo
         </a>
        </div>
       </div>
